...
tf.app.flags.DEFINE_integer('max_steps', 5003, 'the max training steps ')
tf.app.flags.DEFINE_integer('batch_size', 1, 'Validation batch size')
tf.app.flags.DEFINE_integer('eval_steps', 500000, "the step num to eval")
